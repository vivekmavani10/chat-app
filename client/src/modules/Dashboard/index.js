...
const Dashboard = () => {
  ...
  const sendMessage = async () => {
    if (socket) {
      ...
      // Send the message to the server via an API call to store it in the database
      ...
      // Update the UI with the new message after sending
      setMessages((prevMessages) => ({
        ...prevMessages,
        messages: [...prevMessages.messages, { user: user, message }],
      }));
